...
class TeamUsersControllerTest < ActionController::TestCase
  ...
  test "should create team_user" do
    assert_difference('TeamUser.count') do
      post :create, team_user: { admin: @team_user.admin, team_id: @team_user.team_id, user_id: @team_user.user_id }
    end
  ...
  test "should update team_user" do
    patch :update, id: @team_user, team_user: { admin: @team_user.admin, team_id: @team_user.team_id, user_id: @team_user.user_id }
    assert_redirected_to team_user_path(assigns(:team_user))
  end
